...
#   location = "global"
#   depends_on = [
#     azurerm_key_vault_certificate.le[0]
#   ]
...
#         azure_key_vault_certificate_secret_name    = azurerm_key_vault_certificate.le[0].name
#         azure_key_vault_certificate_secret_version = azurerm_key_vault_certificate.le[0].version
